...
class BackupProcess implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $command = "mysqldump -u root --databases inventario > ".$storagePath."backup_".$date.".sql";
        //$command = "mysqldump --column-statistics=0 -u root --databases inventario > ".$storagePath."backup.sql";
        
        
        exec($command, $output, $err);
        sleep(10);
        $backup->status = 'done';
        //$backup->url = $storagePath."backup_".$date.".sql";
